...
>
> 이후 사양 변경은 Design 문서 또는 신규 PRD vN.N로 진행합니다. 최신 운영·배포·법령 수집 기준은 Design v0.2.5의 Vercel + Supabase Seoul 및 고객 BYOK 법령 스냅샷 전략을 우선합니다. 본 문서는 의사결정 컨텍스트 보존용으로 유지됩니다.
